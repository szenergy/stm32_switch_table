...
//	CAN_FilterTypeDef _filter_1;
//	_filter_1.FilterMode = CAN_FILTERMODE_IDLIST;
//	_filter_1.FilterActivation = CAN_FILTER_ENABLE;
//	_filter_1.FilterFIFOAssignment = CAN_FILTER_FIFO0;
//	_filter_1.FilterIdHigh = 0x190;
//	_filter_1.FilterIdLow = 0x123;
//	if (HAL_CAN_ConfigFilter(&hcan2, &_filter_1) != HAL_OK) {
//		User_Error_Handler(UERR_CAN_FILTER_CONFIG);
//	}

	User_Init(&hadc1, &hcan2, &htim3);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED1_Yellow_Pin LED2_Red_Pin LED3_Green_Pin LED4_Blue_Pin */
  GPIO_InitStruct.Pin = LED1_Yellow_Pin|LED2_Red_Pin|LED3_Green_Pin|LED4_Blue_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : Wiper_switch_Pin Hazard_switch_Pin */
  GPIO_InitStruct.Pin = Wiper_switch_Pin|Hazard_switch_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Wiper_DCDC_enable_GPIO_Port, &GPIO_InitStruct);
